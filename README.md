...
```html
<div data-pym-src="http://static.startribune.com/projects/tpaw">Loading...</div>
...
```js
{
  "publish": {
    "default": {
      ...
      "path": "news/projects-staging/all/tpaw/",
      "url": "http://static.startribune.com/news/projects-staging/all/tpaw/"
    },
    "production": {
      "bucket": "static.startribune.com",
      "path": "news/projects/all/tpaw/",
      "url": "http://static.startribune.com/news/projects/all/tpaw/"
    }
  }
}
```
