...
//college enrollment chart
function chartUEnroll() {
    var padding = {
        top: 0,
        right: 40,
        bottom: 20,
    ...
    var chartUEnroll = c3.generate({
        ...
        data: {
            ...
            columns: [
                ['x', 1999,2000,2001,2002,2003,2004,2005,2006,2007,2008,2009,2010,2011,2012,2013,2014,2015,2016,2017,2018],
                ['Rate', null,null,46597,48677,49474,50954,51175,50402,50883,51140,51659,51721,52557,51853,51526,51147,50678,51580,51848,null]
            ],
            type: 'line',
            labels: {
                format: {
...
function chartUGrad() {
    ...
    var chartUGrad = c3.generate({
        ...
        data: {
            ...
            columns: [
                ['x', 1999,2000,2001,2002,2003,2004,2005,2006,2007,2008,2009,2010,2011,2012,2013,2014,2015,2016,2017,2018],
                ['Rate', 0.321,0.323,null,null,null,null,0.29,0.3,0.33,0.36,0.39,0.4,0.41,0.44,0.47,0.51,0.52,0.51,null,null]
            ],
            type: 'line',
            labels: {
                format: {
...
function chartPop() {
    ...
    var chartPop = c3.generate({
        ...
        data: {
            ...
            columns: [
                ['x', 1999,2000,2001,2002,2003,2004,2005,2006,2007,2008,2009,2010,2011,2012,2013,2014,2015,2016,2017,2018],
                ['METRO', null,0.537060124,0.538207866,0.537257805,0.535989593,0.535144376,0.534529274,0.534175389,0.534605622,0.535184175,0.53667848,0.537256277,0.539991923,0.542940423,0.545320282,0.547382933,0.549013193,0.550419634,0.551843899,null],
                ['POC', null,0.118,null,null,null,null,null,null,null,null,null,0.168,0.173,0.177,0.182,0.186,0.191,0.196,0.201,null]
            ],
            type: 'line',
            labels: {
                format: {
